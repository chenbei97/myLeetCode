...
void MainWindow::createActions()
{
      ...
      WorkModeAct= new QAction(tr("工作模式"));
      ...
      WorkModeAct->setShortcut(QKeySequence(Qt::CTRL+Qt::Key_M));
      ...
      WorkModeAct->setIcon(QIcon(pathPrefix+QStringLiteral("monitorSettings")+pathSuffix));
...
//        MenuLanguage->addAction(AboutENAct);
        ...
        MenuMonitor->addAction(WorkModeAct);
