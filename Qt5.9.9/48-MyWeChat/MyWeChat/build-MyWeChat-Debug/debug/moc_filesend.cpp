...
QT_MOC_LITERAL(3, 23, 4) // "name"
    ...
    "FileSend\0sendFileName\0\0name"
};
...
void FileSend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FileSend::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileSend::sendFileName)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FileSend::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FileSend.data,
      qt_meta_data_FileSend,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void FileSend::sendFileName(QString _t1)
{
