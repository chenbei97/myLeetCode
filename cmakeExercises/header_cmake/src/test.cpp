/*
 * @Author: chenbei
 * @Date: 2022-04-30 20:37:10
 * @LastEditTime: 2022-04-30 21:00:21
 * @FilePath: \myLeetCode\cmakeExercises\header_cmake\src\test.cpp
 * @Description: header_cmake's test.cpp
...
void test_for_headerCmake()
{
    ...
    // 寻找1时因为在最后,所以下边界存在,上边界不存在,er.second不能打印所以注释掉
