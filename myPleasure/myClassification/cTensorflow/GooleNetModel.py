'''
Author: chenbei
Date: 2022-04-25 20:09:07
LastEditTime: 2022-04-25 20:13:01
FilePath: \myLeetCode\myPleasure\myClassification\cTensorflow\GooleNetModel.py
Description: GooleNet's model.py
...
class Inception(layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        ...
        return outputs
# 带Auxiliary Classifier的Inception层
...
def GoogLeNet(im_height=224, im_width=224, class_num=1000, aux_logits=False):
    # aux_logits: 是否使用Auxiliary Classifier
