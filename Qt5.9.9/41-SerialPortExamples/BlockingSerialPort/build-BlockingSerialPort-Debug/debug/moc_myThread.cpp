...
QT_MOC_LITERAL(5, 27, 7) // "timeout"

    },
    "myThread\0response\0\0s\0error\0timeout"
};
...
void myThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (myThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myThread::response)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (myThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myThread::timeout)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void myThread::response(const QString & _t1)
{
...
// SIGNAL 1
void myThread::error(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void myThread::timeout(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
