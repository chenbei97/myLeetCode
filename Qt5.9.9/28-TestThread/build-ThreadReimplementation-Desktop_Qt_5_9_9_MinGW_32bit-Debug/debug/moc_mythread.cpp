...
#include "../../ThreadReimplementation/mythread.h"
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::resultReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::resultReady(const QString & _t1)
{
