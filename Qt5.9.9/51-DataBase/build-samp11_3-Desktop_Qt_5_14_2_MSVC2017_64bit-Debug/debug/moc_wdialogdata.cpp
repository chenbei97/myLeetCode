...
#include <memory>
#include "../../samp11_3QueryEdit/wdialogdata.h"
...
void WDialogData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WDialogData *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WDialogData::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_WDialogData.data,
    qt_meta_data_WDialogData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
