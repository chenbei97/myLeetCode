...
QT_MOC_LITERAL(5, 31, 7) // "timeout"
    ...
    "clientThread\0response\0\0s\0error\0timeout"
};
...
void clientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (clientThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&clientThread::response)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (clientThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&clientThread::error)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (clientThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&clientThread::timeout)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void clientThread::response(const QString & _t1)
{
...
// SIGNAL 1
void clientThread::error(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void clientThread::timeout(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
