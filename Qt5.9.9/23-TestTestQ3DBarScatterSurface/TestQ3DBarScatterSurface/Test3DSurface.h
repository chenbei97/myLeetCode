#ifndef TEST3DSURFACE_H
#define TEST3DSURFACE_H
...
class Test3DSurface : public QMainWindow
{
  Q_OBJECT
private:
    QWidget         *graphContainer;// 图表容器
    ...
    void iniGraph3D();
public:
  explicit Test3DSurface(QWidget *parent = nullptr);
  ~Test3DSurface();
