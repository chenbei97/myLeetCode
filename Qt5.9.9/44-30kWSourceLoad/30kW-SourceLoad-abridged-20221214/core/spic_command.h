...
namespace SPICCOMAND {
    ...
    enum  SOURce{
         ...
         /*（5）************************************电压、电流、功率的过、欠保护启用、限定值和延迟时间的设定 开始*************************************/
          ...
          SOUR_VOLT_PROT_DEL_DEF_INQUIRE, // "SOUR:VOLT:PROT:DEL? DEF"
          SOUR_VOLT_PROT_DEL_MIN_INQUIRE, // "SOUR:VOLT:PROT:DEL? MIN"
          SOUR_VOLT_PROT_DEL_MAX_INQUIRE, // "SOUR:VOLT:PROT:DEL? MAX"
          ...
          SOUR_VOLT_UND_PROT_DEL_DEF_INQUIRE, // "SOUR:VOLT:UND:PROT:DEL? DEF"
          SOUR_VOLT_UND_PROT_DEL_MIN_INQUIRE, // "SOUR:VOLT:UND:PROT:DEL? MIN"
          SOUR_VOLT_UND_PROT_DEL_MAX_INQUIRE, // "SOUR:VOLT:UND:PROT:DEL? MAX"
          ...
          SOUR_CURR_PROT_DEL_DEF_INQUIRE, // "SOUR:CURR:PROT:DEL? DEF"
          SOUR_CURR_PROT_DEL_MIN_INQUIRE, // "SOUR:CURR:PROT:DEL? MIN"
          SOUR_CURR_PROT_DEL_MAX_INQUIRE, // "SOUR:CURR:PROT:DEL? MAX"
          ...
          SOUR_CURR_UND_PROT_DEL_DEF_INQUIRE, // "SOUR:CURR:UND:PROT:DEL? DEF"
          SOUR_CURR_UND_PROT_DEL_MIN_INQUIRE, // "SOUR:CURR:UND:PROT:DEL? MIN"
          SOUR_CURR_UND_PROT_DEL_MAX_INQUIRE, // "SOUR:CURR:UND:PROT:DEL? MAX"
    ...
    static QHash <IEee488,QString> IEEE488 = {
          ...
          {IEee488::SAV,QStringLiteral("*SAV")}, // 需要空格 SAV和RCL需要跟上1个数,范围0-9
          ...
          {IEee488::SRE,QStringLiteral("*SRE")}, // 需要空格 数值范围0-255
          {IEee488::SRE_INQUIRE,QStringLiteral("*SRE?")},

          {IEee488::PSC,QStringLiteral("*PSC")}, // 需要空格 ON/OFF
          {IEee488::PSC_INQUIRE,QStringLiteral("*PSC?")},

          {IEee488::ESE,QStringLiteral("*ESE")}, // 需要空格 数值范围0-255
    ...
    static QHash<SOURce,QString> SOURCE= {
          ...
          {SOURce::SOUR_VOLT_PROT_DEL_DEF_INQUIRE,                                                        QStringLiteral("SOUR:VOLT:PROT:DEL? DEF")},
          {SOURce::SOUR_VOLT_PROT_DEL_MIN_INQUIRE,                                                        QStringLiteral("SOUR:VOLT:PROT:DEL? MIN")},
          {SOURce::SOUR_VOLT_PROT_DEL_MAX_INQUIRE,                                                       QStringLiteral("SOUR:VOLT:PROT:DEL? MAX")},
          ...
          {SOURce::SOUR_VOLT_UND_PROT_DEL_DEF_INQUIRE,                                             QStringLiteral("SOUR:VOLT:UND:PROT:DEL? DEF")},
          {SOURce::SOUR_VOLT_UND_PROT_DEL_MIN_INQUIRE,                                             QStringLiteral("SOUR:VOLT:UND:PROT:DEL? MIN")},
          {SOURce::SOUR_VOLT_UND_PROT_DEL_MAX_INQUIRE,                                            QStringLiteral("SOUR:VOLT:UND:PROT:DEL? MAX")},
          // 启用或禁用过电流保护。如果已启用过电流保护功能且输出进入电流限制，则将禁用输出
          ...
          {SOURce::SOUR_CURR_PROT_DEL_DEF_INQUIRE,                                                        QStringLiteral("SOUR:CURR:PROT:DEL? DEF")},
          {SOURce::SOUR_CURR_PROT_DEL_MIN_INQUIRE,                                                        QStringLiteral("SOUR:CURR:PROT:DEL? MIN")},
          {SOURce::SOUR_CURR_PROT_DEL_MAX_INQUIRE,                                                      QStringLiteral("SOUR:CURR:PROT:DEL? MAX")},
          // 启用或禁用欠电流保护。如果已启用欠电流保护功能且输出进入电流限制，则将禁用输出
          ...
          {SOURce::SOUR_CURR_UND_PROT_DEL_DEF_INQUIRE,                                             QStringLiteral("SOUR:CURR:UND:PROT:DEL? DEF")},
          {SOURce::SOUR_CURR_UND_PROT_DEL_MIN_INQUIRE,                                             QStringLiteral("SOUR:CURR:UND:PROT:DEL? MIN")},
          {SOURce::SOUR_CURR_UND_PROT_DEL_MAX_INQUIRE,                                            QStringLiteral("SOUR:CURR:UND:PROT:DEL? MAX")},
          // 启用或禁用过功率保护。如果已启用过功率保护功能且输出进入功率限制，则将禁用输出
   ...
   // 固定查询命令的常量字符串：电压、电流、功率和电阻(暂时空出)的命令
    ...
    static QByteArray getSetCommand(SETTINGVARIABLE role,const QByteArray& value)
    {
          ...
          switch (role)
          {
                case PowerSource: ret = SourceCommandBytes(SOURce::SOUR_POW_LIM);break; // "SOUR:POW:LIM 10"
                case PowerLoad: ret = SourceCommandBytes(SOURce::SOUR_POW_LIM_NEG);break; // "SOUR:POW:LIM:NEG 10"
                case ResistanceSource: ret = SourceCommandBytes(SOURce::SOUR_RES_LIM);break;// "SOUR:RES:LIM 10"
                case ResistanceLoad: ret = SourceCommandBytes(SOURce::SOUR_RES_LIM_NEG);break;// "SOUR:RES:LIM:NEG 10"

                case Voltage: ret = SourceCommandBytes(SOURce::SOUR_VOLT);break; // "SOUR:VOLT 50"
                case CurrentSource: ret = SourceCommandBytes(SOURce::SOUR_CURR_LIM);break; // "SOUR:CURR:LIM 10"
                case CurrentLoad: ret = SourceCommandBytes(SOURce::SOUR_CURR_LIM_NEG);break; // "SOUR:CURR:LIM:NEG 10"

                case Current: ret = SourceCommandBytes(SOURce::SOUR_CURR);break; // "SOUR:CURR 50"
                case VoltageSource: ret = SourceCommandBytes(SOURce::SOUR_VOLT_LIM);break; // "SOUR:VOLT:LIM 10"
                case VoltageLoad: ret = SourceCommandBytes(SOURce::SOUR_VOLT_LIM_NEG);break; // "SOUR:VOLT:LIM:NEG 10"
    ...
    static QByteArray getQueryCommand(SETTINGVARIABLE role)
    {
          ...
          switch (role)
          {
                case PowerSource: ret = SourceCommandBytes(SOURce::SOUR_POW_LIM_INQUIRE);break; // "SOUR:POW:LIM?"
                case PowerLoad: ret = SourceCommandBytes(SOURce::SOUR_POW_LIM_NEG_INQUIRE);break;// "SOUR:POW:LIM:NEG?"
                case ResistanceSource: ret = SourceCommandBytes(SOURce::SOUR_RES_LIM_INQUIRE);break;// "SOUR:RES:LIM?"
                case ResistanceLoad: ret = SourceCommandBytes(SOURce::SOUR_RES_LIM_NEG_INQUIRE);break;// "SOUR:RES:LIM:NEG?"

                case Voltage: ret = SourceCommandBytes(SOURce::SOUR_VOLT_INQUIRE);break;//"SOUR:VOLT?"
                case CurrentSource: ret = SourceCommandBytes(SOURce::SOUR_CURR_LIM_INQUIRE);break;// "SOUR:CURR:LIM?"
                case CurrentLoad: ret = SourceCommandBytes(SOURce::SOUR_CURR_LIM_NEG_INQUIRE);break;// "SOUR:CURR:LIM:NEG?"

                case Current: ret = SourceCommandBytes(SOURce::SOUR_CURR_INQUIRE);break;// "SOUR:CURR?"
                case VoltageSource: ret = SourceCommandBytes(SOURce::SOUR_VOLT_LIM_INQUIRE);break;// "SOUR:VOLT:LIM?"
                case VoltageLoad: ret = SourceCommandBytes(SOURce::SOUR_VOLT_LIM_NEG_INQUIRE);break;// "SOUR:VOLT:LIM:NEG?"
