...
QT_MOC_LITERAL(5, 30, 7) // "timeout"
    ...
    "serverThread\0request\0\0s\0error\0timeout"
};
...
void serverThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverThread::request)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            typedef void (serverThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serverThread::timeout)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void serverThread::request(const QString & _t1)
{
...
// SIGNAL 1
void serverThread::error(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void serverThread::timeout(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
