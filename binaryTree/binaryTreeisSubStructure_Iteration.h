...
class binaryTreeisSubStructureIteration{
    ...
    protected:
        ...
        // 这个网站提供的方法是错的,如果用main中的案例,当遍历到tree1的5和tree2的2,就在compareSubtree函数返回false
        // 实际上tree1应当移动到下一级继续寻找可能的与tree2的2错位相等的节点
        ...
        bool compareSubtree(TreeNode*r1,TreeNode*r2){
            ...
            // cout<<r1->val<<"  "<<r2->val<<endl; 在这里,如果使用网站给出的方法,tree1允许到节点5,tree2为2,5≠2,就返回false
