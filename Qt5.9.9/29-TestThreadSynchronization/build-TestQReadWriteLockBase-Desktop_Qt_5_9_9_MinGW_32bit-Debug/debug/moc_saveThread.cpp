...
#include "../../TestQReadWriteLockBase/saveThread.h"
...
void saveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&saveThread::saveValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void saveThread::saveValue(int _t1)
{
