...
#include "../../TestQReadWriteLockBase/readThread.h"
...
QT_MOC_LITERAL(1, 11, 9), // "readValue"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3) // "ret"

    },
    "readThread\0readValue\0\0ret"
};
...
void readThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&readThread::readValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void readThread::readValue(int _t1)
{
