...
Communication::Communication(QWidget * parent) :QDialog(parent),
      ...
      mHostName(tr("192.168.0.138")),mHostPort(8080),mTcpSocket(new QTcpSocket),mTcpFixedQueryThread(new QThread),
      mTcpSetQueryThread(new QThread),mTcpFixedQueryWorker(new TcpFixedQuery(mTcpSocket)),mTcpSetQueryWorker(new TcpSetQuery(mTcpSocket)),
      mTcpFixedQueryTimer(new QTimer(this))
{
