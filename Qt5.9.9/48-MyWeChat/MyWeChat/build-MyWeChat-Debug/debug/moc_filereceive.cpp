...
struct qt_meta_stringdata_FileReceive_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FileReceive_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FileReceive_t qt_meta_stringdata_FileReceive = {
    {
QT_MOC_LITERAL(0, 0, 11) // "FileReceive"
...
const QMetaObject FileReceive::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FileReceive.data,
      qt_meta_data_FileReceive,  qt_static_metacall, nullptr, nullptr}
};
...
void *FileReceive::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileReceive.stringdata0))
