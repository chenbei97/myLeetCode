...
#include "../../TestMultiWindow/tableSizeDialog.h"
...
QT_MOC_LITERAL(6, 53, 29), // "on_spinBoxColumn_valueChanged"
QT_MOC_LITERAL(7, 83, 4), // "arg1"
QT_MOC_LITERAL(8, 88, 26), // "on_spinBoxRow_valueChanged"
QT_MOC_LITERAL(9, 115, 16), // "on_btnOK_clicked"
QT_MOC_LITERAL(10, 132, 20) // "on_btnCancel_clicked"

    },
    "tableSizeDialog\0rowChanged\0\0row\0"
    "columnChanged\0column\0on_spinBoxColumn_valueChanged\0"
...
void tableSizeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->columnChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_spinBoxColumn_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->on_spinBoxRow_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (tableSizeDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tableSizeDialog::rowChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (tableSizeDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tableSizeDialog::columnChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void tableSizeDialog::rowChanged(int _t1)
{
...
// SIGNAL 1
void tableSizeDialog::columnChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
