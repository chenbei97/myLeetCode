...
#include "../../TestOneQSemaphoreBase/producerConsumerThread.h"
...
QT_MOC_LITERAL(5, 29, 5), // "count"
QT_MOC_LITERAL(6, 35, 5) // "bufId"

    },
    "Consumer\0newValue\0\0int*\0data\0count\0"
    "bufId"
};
#undef QT_MOC_LITERAL
...
void Consumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Consumer::*_t)(int * , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Consumer::newValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Consumer::newValue(int * _t1, int _t2, int _t3)
{
