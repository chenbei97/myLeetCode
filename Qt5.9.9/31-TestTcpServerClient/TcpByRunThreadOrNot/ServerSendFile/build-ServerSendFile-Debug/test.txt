...
QT_MOC_LITERAL(4, 33, 19), // "sendPercentProgress"
QT_MOC_LITERAL(5, 53, 7) // "percent"

    },
    "SendFile\0connected\0\0disconnected\0"
    "sendPercentProgress\0percent"
};
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SendFile *_t = static_cast<SendFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connected(); break;
        case 1: _t->disconnected(); break;
        case 2: _t->sendPercentProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SendFile::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::connected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SendFile::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SendFile::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::sendPercentProgress)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject SendFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SendFile.data,
      qt_meta_data_SendFile,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 2
void SendFile::sendPercentProgress(int _t1)
{
