...
#include "../../TestQChartZoom/customChartView.h"
...
QT_MOC_LITERAL(1, 16, 14), // "mouseMovePoint"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5) // "point"

    },
    "customChartView\0mouseMovePoint\0\0point"
};
...
void customChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        customChartView *_t = static_cast<customChartView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (customChartView::*_t)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&customChartView::mouseMovePoint)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject customChartView::staticMetaObject = {
    { &QChartView::staticMetaObject, qt_meta_stringdata_customChartView.data,
      qt_meta_data_customChartView,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void customChartView::mouseMovePoint(QPoint _t1)
{
